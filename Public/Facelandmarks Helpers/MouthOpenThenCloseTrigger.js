...
//@ui {"widget":"group_start", "label":"Triggers"}
// @input string biteTrigger = "takeABite"
//@ui {"widget":"group_end"}
...
function checkPulse(distance){
    switchState = distance > 0.5 ? 1 : 0;
...
function sendEvent(currentValue) {
    if (currentValue >= 1) {
        global.behaviorSystem.sendCustomTrigger(script.biteTrigger);
    }
}
